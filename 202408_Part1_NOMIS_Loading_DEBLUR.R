...
## Remove samples with less than 3 ecological replicates
...
## Re-build phyloseq object --- metadata with glcode
...
prune_GFS<- prune_samples(sample_sums(merge_GFS_full)>120000,merge_GFS_full)
