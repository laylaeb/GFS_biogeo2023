...
##2024
# phyloseq-class experiment-level object
# otu_table()   OTU Table:         [ 65840 taxa and 330 samples ]
# sample_data() Sample Data:       [ 330 samples by 8 sample variables ]
...
# A tibble: 6 × 3
# Habitat       median_x ratio_GFS_to_other
# <chr>            <dbl>              <dbl>
# 1 Cryoconite         94              13.4  
# 2 Glacier           303               4.15 
# 3 Microbial mat     212               5.92 
# 4 Permafrost        114              11.0  
# 5 Snow              168.              7.50 
# 6 Terrestrial      1864               0.674

# and for Terrestrial 1864/1256 = 1.484076
...
# # A tibble: 6 × 3
# Habitat       median ratio_GFS_to_other_shannon
# <chr>          <dbl>                      <dbl>
# 1 Cryoconite      2.83                      2.01 
# 2 Glacier         4.28                      1.32 
# 3 Microbial mat   4.95                      1.15 
# 4 Permafrost      4.30                      1.32 
# 5 Snow            2.22                      2.55 
# 6 Terrestrial     6.59                      0.861

### and for Terrestrial 6.59/5.675133=1.161206
