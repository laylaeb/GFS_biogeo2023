...
### Here we removed the Uganda taxa - graphs only computed on 10 regions
...
# type                sum  fraction    ymax    ymin labelPosition
# <fct>             <int>     <dbl>   <dbl>   <dbl>         <dbl>
# 1 core                163 0.00302   0.00302 0             0.00151
# 2 core_indicator        2 0.0000370 0.00305 0.00302       0.00304
# 3 indicator          6636 0.123     0.126   0.00305       0.0645 
# 4 endemic_indicator 13884 0.257     0.383   0.126         0.254  
# 5 endemic_uniq      13594 0.252     0.635   0.383         0.509  
# 6 endemic            6139 0.114     0.748   0.635         0.691  
# 7 Other             13601 0.252     1       0.748         0.874  
# > sum(datToPlot$sum)
# [1] 54019 --> this is the right code without Uganda!
...
# # A tibble: 7 × 5
# type              fraction  ymax  ymin labelPosition
# <fct>                <dbl> <dbl> <dbl>         <dbl>
# 1 core               0.301   0.301 0             0.151
# 2 core_indicator     0.00357 0.305 0.301         0.303
# 3 indicator          0.174   0.479 0.305         0.392
# 4 endemic_indicator  0.0913  0.570 0.479         0.524
# 5 endemic_uniq       0.0214  0.591 0.570         0.581
# 6 endemic            0.00973 0.601 0.591         0.596
# 7 Other              0.399   1     0.601         0.801
