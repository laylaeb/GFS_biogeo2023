...
library(breakaway, quietly = T, warn.conflicts = F)
library(data.table, quietly = T, warn.conflicts = F)
library(phyloseq, quietly = T, warn.conflicts = F)
library(microViz, quietly = T, warn.conflicts = F)
library(viridis, quietly = T, warn.conflicts = F)
library(hrbrthemes, quietly = T, warn.conflicts = F)
library(paletteer, quietly = T, warn.conflicts = F)
library(microbiome, quietly = T, warn.conflicts = F)
library(mgcv, quietly = T, warn.conflicts = F)

## read in filtered, merged and rarefied deblur otu table
...
hill_q1_nomis<-as.data.frame(hill_taxa(t(prune_Uganda_df), q = 0))
...
median_shannon_hill<- meta_diversity_nomis_hill %>% 
  summarise(median=median(hill_taxa.t.prune_Uganda_df...q...0. ), x = quantile(hill_taxa.t.prune_Uganda_df...q...0. , c(0.25, 0.5, 0.75)))
...
#' # the effect of latitude on altitude
#+ echo=FALSE, warning=FALSE
