...
## Load dataset
dat <- read_csv("../Revision_2/20240221_NOMIS_rarefied_deblur_table.csv.gz")
tax <- read_csv("../Revision_2/20240221_NOMIS_rarefied_deblur_taxonomy.csv.gz")
meta <- read_tsv("../Revision_2/202402_NOMIS_metadata_GFS.tsv")
